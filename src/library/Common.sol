...
contract Common {
    ...
    uint256 public constant BLOCK_HEADER_NUMBER_INDEX = 8;
    uint256 public constant BLOCK_HEADER_EXTRADATA_INDEX = 12;

    function checkAndDecodeRLP(bytes memory rlpData, bytes32 comparisonBlockHash)
        public
        pure
