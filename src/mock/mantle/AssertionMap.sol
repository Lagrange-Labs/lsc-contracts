...
contract AssertionMap is IAssertionMap {
    ...
    function deleteAssertion(uint256 assertionID) external {
        delete assertions[assertionID];
    }

    function deleteAssertionForBatch(uint256 assertionID) external {
