...
contract BlsOwnCheckTest is BaseScript {
        ...
        returns (IBLSKeyChecker.BLSKeyWithProof memory keyWithProof)
    {
        ...
        if (privateKeys.length == 1 && privateKeys[0] == PRIVATE_KEY_8) {
            keyWithProof.aggG2PublicKey[0][1] = 10964149981093673192878105862123136095629476340728221926737174498877223969648;
            keyWithProof.aggG2PublicKey[0][0] = 15310411369620863421292035563000579947440359652734678186174074640222704784730;
            keyWithProof.aggG2PublicKey[1][1] = 14394448488692205245100592077579864928867873913469847595739357980967122954289;
            keyWithProof.aggG2PublicKey[1][0] = 12973493539966959469484148839766384057653485995822838495480890958868429837596;
        }
        else if (privateKeys.length == 1 && privateKeys[0] == PRIVATE_KEY_9) {
            keyWithProof.aggG2PublicKey[0][1] = 443893656036388665233236242117188127065868835282453062133808678040015042429;
            keyWithProof.aggG2PublicKey[0][0] = 7331548207031936603400747370621041517640282419366011168050780132447131164785;
            keyWithProof.aggG2PublicKey[1][1] = 20990309432715278611468563170296783892531003311534251198264328329085429717735;
            keyWithProof.aggG2PublicKey[1][0] = 19527508948082192170493175951834638819044026564976650183799921676597235202371;
        }
