...
contract LagrangeDeployer is Test {
    ...
    function _calcProofForBLSKeys(uint256 privateKey, uint256[2][] memory blsPubKeys, bytes32 salt)
        internal
        view
    ...
    function _calcProofForBLSKeys(uint256 privateKey, uint256[2][] memory blsPubKeys)
        internal
        view
        returns (IBLSKeyChecker.BLSKeyWithProof memory keyWithProof)
    {
        return _calcProofForBLSKeys(privateKey, blsPubKeys, bytes32("salt"));
    }

    function _calcProofForBLSKey(uint256 privateKey, uint256[2] memory blsPubKey)
        internal
        view
        returns (IBLSKeyChecker.BLSKeyWithProof memory keyWithProof)
    {
        ...
        return _calcProofForBLSKeys(privateKey, blsPubKeys);
    }

    function _calcProofForBLSKey(uint256 privateKey, uint256[2] memory blsPubKey, bytes32 salt)
        internal
        view
        returns (IBLSKeyChecker.BLSKeyWithProof memory keyWithProof)
    {
        uint256[2][] memory blsPubKeys = new uint256[2][](1);
        blsPubKeys[0] = blsPubKey;
        return _calcProofForBLSKeys(privateKey, blsPubKeys, salt);
    }
