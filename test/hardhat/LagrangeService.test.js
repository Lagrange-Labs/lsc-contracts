...
describe("LagrangeService",
    function () {
        ...
        beforeEach(async function () {
            ...
            const lsm = await LSMFactory.deploy(slasher.address, lc.address, admin.address, overrides);
            await lsm.deployed();
            ...
            const lagrangeService = await LSFactory.deploy(lc.address, lsm.address, overrides);
